...
class CategorieStoreController extends AbstractController
{
    ...
    {
        return $this->render('categorie_store/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('categorie_store/new.html.twig', [
            'categorie' => $categorie,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('categorie_store/show.html.twig', [
            'categorie' => $categorie,
        ]);
    }
    ...
    public function edit(Request $request, Categorie $categorie, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('categorie_store/edit.html.twig', [
            'categorie' => $categorie,
            'form' => $form,
        ]);
    }
